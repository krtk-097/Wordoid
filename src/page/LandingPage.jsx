...
const flashMessage = {
  notFound:
    "Github repository you are looking for is not found or may be private",
          ...
          <form onSubmit={handleSubmit}>
            <FormControl>
              ...
              <TextInput
                ...
                name="github_link"
                placeholder="e.g. https://github.com/krtk-097/Wordoid"
      ...
      <Box bg="canvas.default" width="100%" minHeight="100vh">
        <PageLayout width="100%">
          <PageLayout.Header>
            ...
            >
              <div>
                ...
                <Text
                  sx={{ padding: "10px", fontWeight: "bold", fontSize: "25px" }}
                >
                  Wordoid
                </Text>
              </div>
              ...
              <div>
                <Link
                  target="_blank"
                  href=" https://github.com/krtk-097/Wordoid"
                >
                  <Avatar
          ...
          <PageLayout.Content>
            ...
            <Box bg="canvas.default" width="100%">
              ...
              >
                ...
                >
                  Ever felt the need to explore multiple files from a GitHub
                  repository?
                </Heading>
                ...
                >
                  and inspect multiple files with the built-in code editor at
                  once
                  <br />
                  without forking.!
                </Heading>
          ...
          <PageLayout.Footer sx={{ paddingTop: "80px" }}>
            ...
            >
              <Link href="https://github.com/krtk-097" target="_blank">
                Designed & Built with 🤍 by Kartik Sharma
              </Link>
            </Box>
            ...
            >
              ...
              >
                <Link
                  target="_blank"
                  href="https://primer.style/react/getting-started"
                >
